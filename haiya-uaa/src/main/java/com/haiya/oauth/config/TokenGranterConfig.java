...
import com.haiya.oauth.granter.MobilePwdGranter;
import com.haiya.oauth.granter.OpenIdGranter;
import com.haiya.oauth.granter.PwdImgCodeGranter;
import com.haiya.oauth.service.IValidateCodeService;
import com.haiya.oauth.service.impl.CustomTokenServices;
...
public class TokenGranterConfig {
     ...
     * 是否登录同应用同账号互踢
     */
    @Value("${haiya.uaa.isSingleLogin:false}")
