package com.haiya.redis.lock;


import com.haiya.common.constant.CommonConstant;
import com.haiya.common.exception.LockException;
import com.haiya.common.lock.DistributedLock;
import com.haiya.common.lock.ZLock;
...
@ConditionalOnProperty(prefix = "haiya.lock", name = "lockerType", havingValue = "REDIS", matchIfMissing = true)
