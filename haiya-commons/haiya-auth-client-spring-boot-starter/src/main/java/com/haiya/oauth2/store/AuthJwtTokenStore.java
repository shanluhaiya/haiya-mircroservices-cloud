...
import com.haiya.oauth2.converter.CustomUserAuthenticationConverter;
 ...
 * @author qiaoguoqiang
 */
@ConditionalOnProperty(prefix = "haiya.oauth2.token.store", name = "type", havingValue = "authJwt")
